...
const Header = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8 lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem]" href="#hero">
          <img src={brainwave} width={190} height={40} alt="BrainWaveHero" /> 
        </a>
        ...
        <a href="#signup" className="button hidden mr-8 text-n-1/50 transition-colors hover:text-color-n-1 lg:block">
              New Account
        </a>
